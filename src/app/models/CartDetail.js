...
CartDetail.add = (cart_id, product_id, quantity, total_price) => {
    return db.query(`INSERT INTO cart_details (cart_id, product_id, quantity, total_price) VALUES ($1, $2, $3, $4) RETURNING total_price`, [cart_id, product_id, quantity, total_price])
}
...
CartDetail.update = (cart_id, product_id, quantity, total_price) => {
    return db.query(`UPDATE cart_details SET quantity = $3, total_price = $4 WHERE cart_id = $1 AND product_id = $2 RETURNING cart_id`, [cart_id, product_id, quantity, total_price])
}
